...
module.exports = function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),key = locals_.key,entity = locals_.entity;buf.push("<tr" + (jade.attrs({ 'id':("row_" + (key) + "") }, {"id":true})) + "><td class=\"col_device\">" + (jade.escape(null == (jade.interp = entity.device) ? "" : jade.interp)) + "</td><td class=\"col_alias\">" + (jade.escape(null == (jade.interp = entity.alias) ? "" : jade.interp)) + "</td><td class=\"col_index type_numeric\">" + (jade.escape(null == (jade.interp = entity.index) ? "" : jade.interp)) + "</td><td class=\"col_value type_numeric\">" + (jade.escape(null == (jade.interp = entity.value) ? "" : jade.interp)) + "</td></tr>");;return buf.join("");
};
...
},{"events":12,"util":13}],13:[function(require,module,exports){
var events = require('events');
...
},{"querystring":15}],16:[function(require,module,exports){
...
},{"http":17}],12:[function(require,module,exports){
...
},{"events":12,"./lib/request":18}],7:[function(require,module,exports){
...
},{"stream":11,"util":13,"bops":19}],20:[function(require,module,exports){
...
},{"url":14,"http":17,"https":16,"through":21,"duplexer":22,"__browserify_process":10,"__browserify_buffer":20}],21:[function(require,module,exports){
...
},{"stream":11,"__browserify_process":10}],22:[function(require,module,exports){
var Stream = require("stream")
...
},{"./from.js":23,"./to.js":24,"./is.js":25,"./subarray.js":26,"./join.js":27,"./copy.js":28,"./create.js":29,"./read.js":30,"./write.js":31}],32:[function(require,module,exports){
(function(){// UTILITY
var util = require('util');
var Buffer = require("buffer").Buffer;
var pSlice = Array.prototype.slice;
...
},{"util":13,"buffer":33}],25:[function(require,module,exports){
...
},{"assert":32,"./buffer_ieee754":35,"base64-js":36}],30:[function(require,module,exports){
module.exports = {
...
},{"stream":11,"buffer":33,"./response":34,"concat-stream":38}],36:[function(require,module,exports){
(function (exports) {
	'use strict';
...
},{"stream":11,"util":13,"__browserify_buffer":20}],23:[function(require,module,exports){
module.exports = from
