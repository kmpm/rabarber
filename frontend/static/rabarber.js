...
},{"./valuetable-tbody.jade":2,"./valuetable-row.jade":3,"./lib/nibble":4}],2:[function(require,module,exports){
var jade = require("jade/runtime");

module.exports = function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),data = locals_.data;// iterate data
;(function(){
  var $$obj = data;
...
buf.push("<tr" + (jade.attrs({ 'id':("row_" + (key) + "") }, {"id":true})) + "><td class=\"col_device\">" + (jade.escape(null == (jade.interp = entity.device) ? "" : jade.interp)) + "</td><td class=\"col_alias\">" + (jade.escape(null == (jade.interp = entity.alias) ? "" : jade.interp)) + "</td><td class=\"col_index type_numeric\">" + (jade.escape(null == (jade.interp = entity.index) ? "" : jade.interp)) + "</td><td class=\"col_value type_numeric\">" + (jade.escape(null == (jade.interp = entity.value) ? "" : jade.interp)) + "</td><td class=\"col_change\">" + (jade.escape(null == (jade.interp = entity.lastChange) ? "" : jade.interp)) + "</td><td class=\"col_read\">" + (jade.escape(null == (jade.interp = entity.lastRead) ? "" : jade.interp)) + "</td></tr>");
    }

  } else {
    var $$l = 0;
    for (var key in $$obj) {
      $$l++;      var entity = $$obj[key];
...
module.exports = function anonymous(locals) {
var buf = [];
var locals_ = (locals || {}),key = locals_.key,entity = locals_.entity;buf.push("<tr" + (jade.attrs({ 'id':("row_" + (key) + "") }, {"id":true})) + "><td class=\"col_device\">" + (jade.escape(null == (jade.interp = entity.device) ? "" : jade.interp)) + "</td><td class=\"col_alias\">" + (jade.escape(null == (jade.interp = entity.alias) ? "" : jade.interp)) + "</td><td class=\"col_index type_numeric\">" + (jade.escape(null == (jade.interp = entity.index) ? "" : jade.interp)) + "</td><td class=\"col_value type_numeric\">" + (jade.escape(null == (jade.interp = entity.value) ? "" : jade.interp)) + "</td><td class=\"col_change\">" + (jade.escape(null == (jade.interp = entity.lastChange) ? "" : jade.interp)) + "</td><td class=\"col_read\">" + (jade.escape(null == (jade.interp = entity.lastRead) ? "" : jade.interp)) + "</td></tr>");;return buf.join("");
};
...
},{"concat-stream":7,"hyperquest":8,"q":9}],10:[function(require,module,exports){
...
},{"querystring":12}],13:[function(require,module,exports){
...
},{"http":14}],15:[function(require,module,exports){
...
},{"events":16,"./lib/request":18}],7:[function(require,module,exports){
...
},{"stream":15,"util":17,"bops":19}],20:[function(require,module,exports){
...
},{"url":11,"http":14,"https":13,"through":21,"duplexer":22,"__browserify_process":10,"__browserify_buffer":20}],21:[function(require,module,exports){
...
},{"stream":15,"__browserify_process":10}],22:[function(require,module,exports){
var Stream = require("stream")
...
},{"stream":15}],19:[function(require,module,exports){
var proto = {}
...
},{"./from.js":23,"./to.js":24,"./is.js":25,"./join.js":26,"./copy.js":27,"./subarray.js":28,"./read.js":29,"./create.js":30,"./write.js":31}],32:[function(require,module,exports){
(function(){// UTILITY
var util = require('util');
var Buffer = require("buffer").Buffer;
var pSlice = Array.prototype.slice;
...
},{"util":17,"buffer":33}],25:[function(require,module,exports){
...
},{"stream":15}],35:[function(require,module,exports){
exports.readIEEE754 = function(buffer, offset, isBE, mLen, nBytes) {
  var e, m,
      eLen = nBytes * 8 - mLen - 1,
      eMax = (1 << eLen) - 1,
...
},{"assert":32,"./buffer_ieee754":35,"base64-js":36}],29:[function(require,module,exports){
module.exports = {
...
},{"./mapped.js":37}],31:[function(require,module,exports){
module.exports = {
...
},{"./mapped.js":37}],18:[function(require,module,exports){
...
},{"stream":15,"buffer":33,"./response":34,"concat-stream":38}],36:[function(require,module,exports){
(function (exports) {
	'use strict';
...
},{"stream":15,"util":17,"__browserify_buffer":20}],23:[function(require,module,exports){
module.exports = from
...
},{"base64-js":39}],24:[function(require,module,exports){
module.exports = to
...
},{"base64-js":39,"to-utf8":40}],39:[function(require,module,exports){
(function (exports) {
	'use strict';
